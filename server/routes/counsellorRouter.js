...
var counsellorRouter = express.Router();
...
var router = () => {
    ...
    // authenticate user
    counsellorRouter.use(async (req, res, next) => {
        try {
    ...
    counsellorRouter.route('/')
        .get(async (req, res) => {
            res.render('admin', {docs: await Ranking.getAll()});
        })

    counsellorRouter.route('/check')
        .get((req, res) => {
    ...
    counsellorRouter.post('/create', async (req, res) => {
    ...
    counsellorRouter.post('/remove', async (req, res) => {
        try {
    ...
    counsellorRouter.post('/update', async (req, res) => {
